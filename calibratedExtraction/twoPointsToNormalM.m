...
function n = twoPointsToNormalM(xHat1,xHat2,alpha1,alpha2,s)

n = [xHat1(2,:).*alpha2-xHat2(2,:).*alpha1; 
     s*(xHat2(1,:).*alpha1-xHat1(1,:).*alpha2); 
     xHat2(1,:).*xHat1(2,:)-xHat1(1,:).*xHat2(2,:)];

nNorm = sqrt(n(1,:).^2+n(2,:).^2+n(3,:).^2);
n = bsxfun(@rdivide,n,nNorm);
