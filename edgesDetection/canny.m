function [e ax ay axx axy ayx ayy]=canny(a,sigma,thresh,thresh_scaling)
  ...
  axx = imfilter(ax, dgau2D, 'conv','replicate');
  axy = imfilter(ax, dgau2D', 'conv','replicate');
  ayx = imfilter(ay, dgau2D, 'conv','replicate');
  ayy = imfilter(ay, dgau2D', 'conv','replicate');
  ...
  lowThresh=lowThresh*thresh_scaling(1);
  highThresh=highThresh*thresh_scaling(2);
