...
function xHat = hModel(X,calib,modelClass)
...
switch(modelClass)
    case 1,
        xHat = hPara(X,calib(1));
    case 2,
        xHat = hHyper(X,calib(2),K_c);
    case 3,
        xHat = hEqui(X,calib(1));
    case 4,
        xHat = hStereo(X,calib(1));
    case 5,
        xHat = hOrtho(X,calib(1));
    case 6,
        xHat = hEquisol(X,calib(1));
end
