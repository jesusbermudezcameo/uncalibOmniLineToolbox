...
function  [acceptedIndex, sizeAccepted, r_vlAcum, isRealFlag] = uncalibratedLineExtraction3Points(xHatSel,xHatTest,nAttempts,rThreshold,modelClass,fH)
...
isRealFlag = zeros(1,size(index,1));
