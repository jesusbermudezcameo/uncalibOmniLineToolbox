...
function algorithm = getAlgorithmFromHandle(handles)
% 1 ParamX - 2 Hyper - 3 Equiangular - 4 StereographicX - 5 Orthogonal - 6 Equisolid

if get(handles.plumblineButton,'Value'), algorithm = 1; end;
if get(handles.gradientButton,'Value'), algorithm = 2; end;
if get(handles.gradientButtonSecond,'Value'), algorithm = 3; end;
