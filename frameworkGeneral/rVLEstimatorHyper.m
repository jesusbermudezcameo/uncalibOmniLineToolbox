...
function rVLHyper = rVLEstimatorHyper(r,l1,l2,l3)

s1 = l1+l2+l3;
s2 = l1^2*r(1)^2+l2^2*r(2)^2+l3^2*r(3)^2;
s3 = l1*l2*(r(1)^2+r(2)^2)+l1*l3*(r(1)^2+r(3)^2)+l2*l3*(r(2)^2+r(3)^2);

rVLHyper=sqrt((s2+s3)/s1^2);
