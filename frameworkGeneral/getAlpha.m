...
function alpha=getAlpha(r,calib,modelClass)

switch(modelClass)
    case 1,
        alpha = getAlphaP(r,calib(1));
    case 2,
        alpha = getAlphaH(r,calib(1),calib(2));
    case 3,
        alpha = getAlphaEq(r,calib(1));
    case 4,
        alpha = getAlphaP(r,calib(1));
    case 5,
        alpha = getAlphaOrtho(r,calib(1));
    case 6,
        alpha = getAlphaSol(r,calib(1));    
end
